 ...
 */
public class FrmLicenciaCosto extends javax.swing.JFrame {
     ...
     */
    public FrmLicenciaCosto(boolean discapacitado) {
        initComponents();
    ...
    public void cargarDatos() {
        List<LicenciaDTO> listaTarifas = new ArrayList<>();
        listaTarifas.add(new LicenciaDTO("1 año", "$600.00", "$200.00"));
        listaTarifas.add(new LicenciaDTO("2 años", "$900.00", "$500.00"));
        listaTarifas.add(new LicenciaDTO("3 años", "$1,100.00", "$700.00"));
        
        DefaultComboBoxModel<LicenciaDTO> modelo = new DefaultComboBoxModel<>();
        for (LicenciaDTO tarifa : listaTarifas) {
    ...
    private void llenarTablaTarifas(List<LicenciaDTO> listaTarifas) {
        ...
        if (listaTarifas != null) {
            listaTarifas.forEach(row -> {
                ...
                fila[0] = row.getVigencia();
                fila[1] = row.getCostoNormal();
                fila[2] = row.getCostoDiscapacitado();
    ...
    private void initComponents() {
        ...
        pnlCamposLayout.setHorizontalGroup(
            ...
            .addGroup(pnlCamposLayout.createSequentialGroup()
                ...
                .addGroup(pnlCamposLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(comboVigencia, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        if (tblTarifas.getColumnModel().getColumnCount() > 0) {
            tblTarifas.getColumnModel().getColumn(2).setResizable(false);
        }
    ...
    private void btnVolverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVolverActionPerformed
        FrmLicenciaDatosCliente frmLicenciaDatosCliente = new FrmLicenciaDatosCliente();
    ...
    private javax.swing.JComboBox<LicenciaDTO> comboVigencia;
