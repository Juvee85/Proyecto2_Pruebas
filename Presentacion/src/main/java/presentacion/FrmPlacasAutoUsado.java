...
public class FrmPlacasAutoUsado extends javax.swing.JFrame {
    ...
    public void cargarDatos() {
        List<PlacasDTO> listaTarifas = new ArrayList<>();
//        listaTarifas.add(new PlacasDTO("Automóvil nuevo", "$1,500.00"));
//        listaTarifas.add(new PlacasDTO("Automóvil usado", "$1,000.00"));
    }
    ...
    private void btnContinuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContinuarActionPerformed
        //        FrmPlacasCliente frmPlacasDatosCliente = new FrmPlacasCliente();
